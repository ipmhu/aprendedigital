...
const DEFAULT_PROGRAMS = [
    ...
    { codigo: "AD-201", nombre: "Digitación y Ofimática Profesional", descripcion: "Domina las herramientas ofimáticas esenciales y técnicas avanzadas de digitación para maximizar tu productividad en el entorno empresarial moderno.", duracion_semanas: 4, precio: 1200.00 },
    { codigo: "AD-301", nombre: "Computación y Soporte Técnico", descripcion: "Fórmate como técnico especializado en soporte de sistemas informáticos. Aprende diagnóstico, mantenimiento preventivo y resolución de problemas técnicos.", duracion_semanas: 3, precio: 1100.00 }
];
...
<div class="header"><h1>Avanza Digital</h1><p>Aprende. Aplica. Avanza.</p><p>+1 (829) 674- | aprendedigital@outlook.com</p></div>
${content}
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    document.getElementById("forgotPasswordLink")?.addEventListener("click", e => { e.preventDefault(); closeLoginModal(); showToast("info", "Recuperar contraseña", "Contacta a soporte: +1 (829) 674-"); });
